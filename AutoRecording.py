...
class AutoRecordingController:
    def __init__(self, CameraStateDB, GpsDB):
        ...
        self.threshold_speed = 3            # Threshold velocity of the surfer (based on gps, m/s) to signal start/stop
        self.threshold_stop_hyster = 6       # These are used for introducing hysteresis to the start/stop condition
